...
<div id="headisi" class="bgheadisi">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td rowspan="2" align="left"><img src="images/headerisi1.png" width="188" height="93" /></td>
      <td valign="bottom" class="tulisanheadisi">Testimonial</td>
      <td rowspan="2" align="right" valign="top"><img src="images/transparanataskana.png" width="184" height="92" /></td>
    </tr>
    <tr>
      <td valign="top"><img src="images/transparanatas.png" width="287" height="17" /></td>
    </tr>
  </table>
</div>
<div id="spasikedua" style=" height:44px"></div>
<div id="isicontent" class="isicontent">
  
<div id="isidiisi" class="isidiisi">
  <p class="dummytulisanatas"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
  <p class="dummytulisanatas">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Testimonial dari Beberapa Customer<br />
    <br />
  </p>
  <div style="float: left"><img border="4px" style="border-color:#FFF" src="images/Person.png" width="120" height="120" /></div>
 <div class="dummytulisanatas" style="float: left">Susiani</div>
 <div class="dummytulisan">
   <p>&nbsp;</p>
   <p>an aktif dalam memberikan motivasi kepada para jamaah pasca haji,   utamanya dalam memelihara dan menjaga nilai-nilai kemabruran ibadah   haji. Nilai-nilai kemabruran haji sangat penting untuk meningkatkan   kualitas iman, ilmu dan amal soleh. Pasca haji, seorang muslim dituntut   dan seyogyanya memilki kesadaran dan tanggung jawab yang lebih holistik.</p>
 </div>
  <div>
    <p>&nbsp;</p>
    <p>&nbsp;</p>
