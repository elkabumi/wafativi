...
<nav id="nav" role="navigation" name="nav">
    ...
    <ul>
      ...
      <li><a href="../home.php?page=artikel">Artikel</a>
      <ul>
            <li><a href="../home.php?page=profilsahabatnabi">Profil Sahabat Nabi</a></li>
                <li><a href="../home.php?page=bisnisislami">Bisnis Islami</a></li>
                <li><a href="../home.php?page=updatemotivasi">Update Motivasi</a></li>
          </ul>
      </li>
...
<table border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td align="center" bgcolor="#00FFFF" style="color:#000; font-family: papyrus;"><strong><a href="../logout.php">LOGOUT</a></strong></td>
    </tr>
    <tr>
      <td align="center"><?php
...
{
echo "<table>";
echo "<tr><td>Nama</td><td> :</td><td> ".$data['name']."</td></tr>";
echo "<tr><td>Email</td><td> : </td><td><a href=mailto:".$data['email'].">".$data['email']."</a></td></tr>";
echo "<tr><td>Message</td><td> : </td><td>".$data['message']."</td></tr>";
echo "</table><hr>";
}
?></td>
    </tr>
